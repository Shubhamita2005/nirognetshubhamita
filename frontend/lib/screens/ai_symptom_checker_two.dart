...
class _AISymptomCheckerState extends State<AISymptomChecker> {
  ...
  void _generateBotResponse(String userMessage) {
    ...
    // Simple mock responses - Replace with actual Gemini API call
    if (userMessage.toLowerCase().contains('headache')) {
      response = "I understand you're experiencing headaches. To better help you, could you tell me:\n\n• How severe is the pain (1-10)?\n• Where exactly does it hurt?\n• How long have you had it?";
    } else if (userMessage.toLowerCase().contains('fever')) {
      response = "You mentioned feeling feverish. Let me ask a few questions:\n\n• What's your temperature?\n• Any other symptoms like chills or sweating?\n• When did the fever start?";
    } else if (userMessage.toLowerCase().contains('stomach')) {
      response = "Stomach pain can have various causes. Please tell me:\n\n• Where exactly is the pain?\n• Is it sharp, dull, or cramping?\n• Did you eat anything unusual?";
    } else if (userMessage.toLowerCase().contains('dizzy')) {
      response = "Dizziness can be concerning. To understand better:\n\n• Do you feel lightheaded or is the room spinning?\n• Does it happen when you stand up?\n• Any nausea or hearing changes?";
    } else if (userMessage.toLowerCase().contains('common symptoms')) {
      response = "Here are symptoms I can help analyze:\n\n• Fever & Chills\n• Headache & Migraine\n• Cough & Cold\n• Stomach Issues\n• Body Aches\n• Skin Problems\n• Breathing Issues\n\nPlease describe what you're experiencing.";
    } else {
      response = "Please provide more details about your symptoms. You can describe:\n\n• What you're feeling\n• When it started\n• How severe it is\n• Any other related symptoms";
    }

    _addBotMessage(response, showSuggestions: showSuggestions);
  }
